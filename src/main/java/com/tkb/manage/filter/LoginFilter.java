...
//			//請求至登入頁或執行登入動作 則導至請求的目的端
			if(request.getServletPath().equals("/tkbrule/login") || request.getServletPath().equals("/tkbrule/manager/doLogin") || request.getServletPath().equals("/tkbrule/teacher/doLogin") || request.getServletPath().equals("/tkbrule/logout")) {
				filterChain.doFilter(request, response);
			} else if(request.getServletPath().equals("/manager/login") || request.getServletPath().equals("/teacher/login") || request.getServletPath().equals("/manager/doLogin") || request.getServletPath().equals("/teacher/doLogin") || request.getServletPath().equals("/logout")) {
				filterChain.doFilter(request, response);
